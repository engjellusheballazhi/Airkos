		...
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item"><span>Udhetim</span></li>
						...
						<form action="book_flight.php" method="post">
							...
							<div class="class">
								...
								<select id="w3_country1" 
									...
									<option value="E">Ekonomik</option>  
									<option value="B">Biznesi</option>   
								</select>
							...
							<div class="clear"></div>
							<input type="submit" value="Kerko" name="search_but">
						</form>						
					</div>		
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<div class=" text-center">&copy; <?php echo date('Y')?> - Kosova-AIR<br><br></div>
	<!-- <p>----------</p> -->
